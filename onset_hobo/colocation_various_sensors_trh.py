# -*- coding: utf-8 -*-
"""
Created on Wed Feb  5 15:58:24 2025
...
main_folder = r'C:\EXP\logger_data\new_trh'
...
# Trim time
start_time = pd.to_datetime('2025-02-05 11:00:00')
end_time = pd.to_datetime('2025-02-05 15:30:00')
df_all = df_all[(df_all['Time'] >= start_time) & (df_all['Time'] <= end_time)]

dict_color = dict(zip(df_all['Sensor'].unique(), ['red', 'blue', 'green']))
